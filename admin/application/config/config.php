...
$config['app_url'] = "http://".$_SERVER['SERVER_NAME']."/LMS/";
$config['media_url'] = $config['app_url'].'uploads/';
$config['appName'] = 'Webtrix LMS';
$config['development'] = true;
$config['imagesPATH'] = $_SERVER['DOCUMENT_ROOT'] . '/LMS/images/';
//$config['mediaPATH'] = $_SERVER['DOCUMENT_ROOT'].'/lms/uploads/';
$config['mediaPATH'] = $_SERVER['DOCUMENT_ROOT'] . '/LMS/uploads/';
...
$config['supportEmail'] = "support@onechange.in";
$config['supportEmailName'] = "One Change";

$config['webmasterEmail'] = "webmaster@crm.com";
$config['mail_server'] = "sendgrid"; // sendgrid
