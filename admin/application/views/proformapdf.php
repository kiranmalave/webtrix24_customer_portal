...
<div style="padding-top: 10px;">
	<div style="float:left; width:30%;">
		<h1 align="left"><strong>Proforma Invoice</strong></h1>
	</div>
				...
				<table width="100%" style="border-collapse: collapse;border-spacing: 0;">
					...
					<tr>
						<td class="border-right">
							...
							<tr>
							<?php if(isset($taxInvoiceData[0]->po_number) && !empty($taxInvoiceData[0]->msme_no)) { ?>
								<td ><?php echo date("d F Y", strtotime($taxInvoiceData[0]->lut_no)); ?></td>
								<?php }else{ ?>
								<td >-</td>
								<?php } ?>
							</tr>
				...
				<table>
					...
					<?php 
						...
						<?php }else{ ?>
							...
							<tr><td><b>GSTN : </b><?php echo $taxInvoiceData[0]->customer_gst; ?></td></tr>
							<tr><td><b>State : </b><?php if(isset($taxInvoiceData[0]->customer_state) && !empty($taxInvoiceData[0]->customer_state)){ echo $taxInvoiceData[0]->customer_state."(".$taxInvoiceData[0]->gst_state_code.")";} ?></td></tr>
							<tr><td><?php if(isset($taxInvoiceData[0]->customer_mobile) && !empty($taxInvoiceData[0]->customer_mobile)) { ?><b>Mobile:</b><?php  $m = json_decode($taxInvoiceData[0]->customer_mobile);if (gettype($m) == 'Array') { if(count($m) > 1){ echo "(".$m[0].") ".$m[1]; }}else{ echo ' '.$taxInvoiceData[0]->customer_mobile;}} ?></td></tr>
						<?php } ?>
				</table>
			</td>
		</tr>
...
<?php 
    ...
    <tr class="borderBottom">
		...
		<td  class="qut border-right text-right"><?php echo number_format($value->invoiceLineQty,0, '.', ''); ?></td>
		<!-- RATE -->
		...
		<td class="amt text-right" style='vertical-align: top;'>	
			<table>
				<tbody>
					<tr>
						<td style="border:none;" class="text-right" ><?php 
							$invoiceTot = 0 ;
    ...
    <?php } ?>
	<tr>
		<td colspan='5' class="border-right text-right" style='vertical-align: top;'></td>
...
<table width="100%" class="border border-botton-none" >
	<tbody>
		<tr>
			<td class="half">
				<table width="100%">
...
<?php if($infoSettings[0]->is_display_payment == 'yes'){ 
	...
	<table width="100%" style="border:1px solid black; margin-top :100px" class="items border">
		<tbody>
			<tr class="borderBottom">
