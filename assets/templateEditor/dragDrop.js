...
(function($, window, document, undefined) {
    ...
    var templateList = settings.templateList;
    // var fAQTemplates = settings.fAQTemplates;
    // var ourWorksTemplates = settings.ourWorksTemplates;
    // var blogsTemplates = settings.blogsTemplates;
    // var listPagesTemplates = settings.listPagesTemplates;
    // var servicesTemplates = settings.servicesTemplates;
    // var ourClientsTemplates = settings.ourClientsTemplates;
    // var ourTeamTemplates = settings.ourTeamTemplates;
    // var careerTemplates = settings.careerTemplates;
    // var testimonialsTemplates = settings.testimonialsTemplates;
    ...
    function setupPlayground(){
        if(playground == null){
            ...
            // Add the new ul element with list items after addRow
   ...
   // Copy-Paste Sections
    ...
    function clipboardPaste() {
        ...
        if (storedContent) {
            $(".ws-playground").append(storedContent);
            $(".defaultView").remove();
