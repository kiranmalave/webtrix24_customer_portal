...
define([
  ...
  'moment',
  'Swal',
  '../views/vendorSingleView',
  '../collections/vendorCollection',
  '../models/vendorFilterOptionModel',
  '../../core/views/configureColumnsView',
  '../../core/views/mailView',
  'text!../templates/vendorRow.html',
  'text!../templates/vendor_temp.html',
...
], function ($, _, Backbone, datepickerBT, moment, Swal, vendorSingleView, vendorCollection, vendorFilterOptionModel, configureColumnsView, mailView, vendorRowTemp, vendorTemp, appSettings, dynamicFormData, moduleDefaultSettings, dynamicFilterView, linkedDropdown, timeselectOptions,deleteCardView) {
  var vendorView = Backbone.View.extend({
    ...
    initialize: function (options) {
      ...
      this.skipFields = ['is_amc', 'shipping', 'track_quantity', 'barcode', 'profile'];
      this.staticJoined = [];
      this.idsToRemove = [];
      this.columnMappings = [{ 'ifsc': 'IFSC Code' }];
      ...
      this.filterOption = new vendorFilterOptionModel();
      ...
      this.deleteURL = 'VendorMaster/multipleHardDelete';
	    this.statusChangeURL = 'VendorMaster/multiplevendorChangeStatus';
    ...
    changeStatusListElement: function (e) {
      if (permission.delete != "yes") {
        ...
        $('#vendorList input:checkbox').each(function () {
          if ($(this).is(":checked")) {
            removeIds.push($(this).attr("data-vendor_id"));
          }
        });
        ...
        $.ajax({
          url: APIPATH + 'vendorMaster/status',
          method: 'POST',
    ...
    loadSubView: function (e) {
      ...
      switch (show) {
        ...
        case "singlevendorData": {
          var vendor_id = $(e.currentTarget).attr("data-vendor_id");
          ...
          if (vendor_id != "" && vendor_id != null && vendor_id != undefined) {
            if (permission.edit != "yes") {
              ...
              new vendorSingleView({ vendor_id: vendor_id, pluginId: selfobj.pluginId, searchvendor: selfobj, menuId: selfobj.menuId, form_label: selfobj.form_label, menuName: this.menuName });
            }
          } else {
    ...
    addOne: function (objectModel) {
      ...
      var template = _.template(vendorRowTemp);
      ...
      $("#vendorList").append(template({ vendorDetails: objectModel, arrangedColumnList: this.arrangedColumnList }));
    },
    addAll: function () {
      $("#vendorList").empty();
 ...
 // SORT DATA ACCORDING TO COLUMN NAMES
  sortColumn: function (e) {
    ...
    render: function () {
      selfobj = this;
      var template = _.template(vendorTemp);
