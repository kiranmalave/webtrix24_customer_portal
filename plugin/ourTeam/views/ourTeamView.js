...
define([
  ...
  'Swal',
  'moment',
  '../views/ourTeamSingleView',
  '../collections/ourTeamCollection',
  '../models/ourTeamFilterOptionModel',
  ...
  'text!../templates/ourTeamRow.html',
  'text!../templates/ourTeam_temp.html',
  'text!../templates/ourTeamFilterOption_temp.html',
  'text!../../dynamicForm/templates/linkedDropdown.html',
  '../../core/views/deleteCardView',
], function ($, _, Backbone, datepickerBT, Swal,moment,ourTeamSingleView, ourTeamCollection, ourTeamFilterOptionModel,configureColumnsView,appSettings,mailView, dynamicFormData,slugCollection,moduleDefaultSettings,timeselectOptions,dynamicFilterView,ourTeamRowTemp, ourTeamTemp, ourTeamFilterTemp,linkedDropdown,deleteCardView) {
  var ourTeamView = Backbone.View.extend({
    module_desc:'',
    plural_label:'',
    form_label:'',
    currPage: 0,
    ...
    initialize: function (options) {
      ...
      this.toClose = "ourTeamFilterView";
      ...
      this.filterOption = new ourTeamFilterOptionModel();
      this.filterOption.set({ "menuId": this.menuId });
      this.collection = new ourTeamCollection();
      this.collection.on('add', this.addOne, this);
      this.collection.on('reset', this.addAll, this);

      this.deleteURL = 'ourTeam/multipleHardDelete';
	    this.statusChangeURL = 'ourTeam/multipleteamChangeStatus'; 
      ...
      if (permission.delete != "yes") {
        ...
        return false;
          ...
          $('#clist input:checkbox').each(function () {
            if ($(this).is(":checked")) {
              removeIds.push($(this).attr("data-team_id"));
            }
          });
          ...
          $.ajax({
            ...
            success: function (res) {
              ...
              setTimeout(function () {
                $(e.currentTarget).html('<i class="material-icons dlt-btn" data-toggle="tooltip" data-placement="top" data-content="Delete" data-original-title="" title="">delete</i>');
                $('.deleteAll').hide();
              }, 3000);
            ...
            $('#teamList input:checkbox').each(function () {
              if ($(this).is(":checked")) {
    ...
    loadSubView: function (e) {
      ...
      switch (show) {
        case "singleteamData": {
          var team_id = $(e.currentTarget).attr("data-team_id");
          if(team_id != "" && team_id != null && team_id != undefined ){
            if (permission.edit != "yes") {
            Swal.fire("You don't have permission to edit", '', 'error');
              return false;
            }else{
              new ourTeamSingleView({ team_id: team_id, searchteam: this, menuId:this.menuId,form_label:selfobj.form_label});
            }
          }else{
    ...
    addOne: function (objectModel) {
      ...
      var template = _.template(ourTeamRowTemp);
      ...
      $("#teamList").append(template({ teamDetails: objectModel,arrangedColumnList:this.arrangedColumnList }));
    },
    addAll: function () {
      $("#teamList").empty();
 ...
 // SORT DATA ACCORDING TO COLUMN NAMES
  sortColumn: function (e) {
    ...
    render: function () {
      let selfobj = this;
      var template = _.template(ourTeamTemp);
