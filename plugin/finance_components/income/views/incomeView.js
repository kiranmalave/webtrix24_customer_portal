define([
...
], function ($, _, Backbone, custom, Swal, incomeModel, settingsView, barChart, pieChart, lineChart, doughnutChart, funnelChart, incomeTemp) {
  ...
  var incomeView = Backbone.View.extend({
    ...
    render: function () {
      var selfobj = this;
      var template = _.template(incomeTemp);
      ...
      if (this.model.get('view_type') == 'graph') {
        ...
        $('.dashEle .customTableClass').css('height', '88%')
      }
