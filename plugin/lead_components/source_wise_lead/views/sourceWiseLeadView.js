define([
  ...
  'text!../templates/sourceWiseLeadTemp.html',
], function ($, _, Backbone, custom, Swal, leadModel, settingsView, barChart, pieChart, lineChart, doughnutChart, funnelChart, sourceWiseLeadTemp) {

  var sourceWiseLeadView = Backbone.View.extend({
    model: leadModel,
    tagName: "div",
    type: 'income',
    ...
    render: function () {
      var selfobj = this;
      var template = _.template(sourceWiseLeadTemp);
