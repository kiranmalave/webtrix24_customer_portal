define([
...
], function ($, _, Backbone, validate, inputmask, datepickerBT,moment,settings, intervalField_temp) {
  ...
  var settingsView = Backbone.View.extend({
    ...
    initializeValidate: function () {
      var selfobj = this;
      startDate = $('#startDate').datepickerBT({
        format: "dd-mm-yyyy",
        todayBtn: "linked",
        clearBtn: true,
        todayHighlight: true,
        ...
        $('#startDate').change();
        selfobj.parentObj.currentElement["startDate"] = $('#startDate').val();
      });
      endDate = $('#endDate').datepickerBT({
        format: "dd-mm-yyyy",
        todayBtn: "linked",
        clearBtn: true,
        todayHighlight: true,
        ...
        $('#endDate').change();
        selfobj.parentObj.currentElement["endDate"] = $('#endDate').val();
      });
