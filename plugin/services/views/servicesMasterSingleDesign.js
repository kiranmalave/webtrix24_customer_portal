define([
  ...
  'text!../templates/servicesMasterSingleTempEdit.html',
], function($,_,Backbone,validate,inputmask,minicolors,Quill,jqueryUI,templateEditor,custom,Swal,servicesSingleModel,readFilesView,servicesMasterTemp){

var servicesMasterSingleDesign = Backbone.View.extend({
    initialize: function(options){
      ...
      if(service_id!=0){
        this.model.set({service_id:service_id});
  ...
  return servicesMasterSingleDesign;
