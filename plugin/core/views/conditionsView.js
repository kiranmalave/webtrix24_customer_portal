...
], function ($, _, Backbone, moment, Swal, filterSingleModel, adminCollection, slugCollection, dynamicFieldRender, multiselectOptions, conditionsTemplate, categoryTemplate, dateConditionTemplate, dropdownTemp, filterConditionLikned, filterFieldListTemp, filterFieldSingle, filterFieldSingleEdit, joinedFieldTemplate) {
    ...
    var conditionsView = Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            this.fromCampaign = (options.fromCampaign) ? 'yes' : 'no';
                this.columnlist = this.parentObj.columnlist ? this.parentObj.columnlist : [];
                ...
                this.conditionList = this.parentObj.conditionList ? this.parentObj.conditionList : [];
                this.logicalList = this.parentObj.logicalList ? this.parentObj.logicalList : [];
        ...
        saveCondition: function () {
            ...
            selfobj.parentObj.model.set({ 'json_data': jsonString })
            selfobj.parentObj.model.set({ 'rowCounter': Object.keys(jsonForm).length })
        },
                            ...
                            if (dynamicColumn) {
                                ...
                                if (statCol) {
                                    ...
                                    if (column.Type == 'datetime' || column.Type == 'timestamp' || column.Type == 'date') {
                                        ...
                                        console.log(dVal);
                                        console.log(selfobj.dateConditionList);
                    ...
                    for (const [key, value] of Object.entries(filterData)) {
                        ...
                        if (columnField) {
                            selfobj.columnMappings.find((map) => {
                                ...
                                console.log('mappedFieldName : ',columnField.mappedFieldName);
                            });
        ...
        render: function () {
            ...
            if ($(".conditionsSelector .conditions").length) {
                $(".conditionsSelector .conditions").empty().append(this.$el);
                this.attachEvents();
                this.initializeDatePicker();
                this.renderConditions(this.parentObj.model.get('json_data'));
                setToolTip();
